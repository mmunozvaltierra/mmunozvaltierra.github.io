        ...
        return (
            <Container className="mt-3">
                ...
                <Container className="text-justify">
                    <Row>
                        <Col>
                            <p id="about-me-text-box-top" className="content-box white-text p-3 mb-0">
                                ...
                                which is why I also use it as my gamertag online. Since it's always available :). I moved to the United States with my family around the age of 2
                    ...
                    <Row>
                        <Col>
                            <p id="about-me-text-box-bot" className="content-box white-text p-3">
